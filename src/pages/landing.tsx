      ...
      <div className="relative bg-card border border-border rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-5 pt-5 pb-4 border-b border-border bg-muted/30">
          <div className="flex items-center gap-2 mb-1">
            <img src="/logo.png" alt="MealPing Logo" className="h-6 w-6 rounded-md shadow-sm" />
            <span className="text-xs font-bold text-foreground">MealPing</span>
          </div>
...
export default function LandingPage() {
  ...
  const FEATURES = [
    ...
    {
      icon: IndianRupee,
      title: t.landing.features.bill.title,
      desc: t.landing.features.bill.desc,
      ...
      <header className="sticky top-0 z-40 bg-card/80 backdrop-blur-md border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <Link to="/admin-login">
              <span className="font-bold text-sm text-foreground cursor-default">MealPing</span>
            </Link>
          </div>
          <div className="flex items-center gap-2">
            <Link to="/sign-in">
