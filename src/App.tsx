  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-background to-background px-4 gap-6">
      <div className="text-center mb-2">
        <img src="/logo.png" alt="MealPing Logo" className="mx-auto h-16 w-16 rounded-[1.25rem] shadow-md mb-3" />
        <h1 className="text-2xl font-black text-foreground">MealPing</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="flex flex-col items-center gap-3">
        <img src="/logo.png" alt="Loading" className="h-12 w-12 rounded-xl animate-pulse shadow-sm" />
...
function HomeRedirect() {
  ...
  if (role === "superadmin") return <Redirect to="/super-admin" />;
...
function SuperAdminRoute() {
  ...
  // Only wait for role check if user is signed in
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-3">
  ...
  return isSuperAdmin ? <SuperAdminPage /> : <Redirect to="/dashboard" />;
}
